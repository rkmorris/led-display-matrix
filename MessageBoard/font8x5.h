// Modified ASCII 8x5 fixed-width font

#define FONT_PITCH      6
#define FONT_FIRST_CHR  0x1D
#define FONT_LAST_CHR   0x7F

// Additional slash '/' character added to 0x1f which
// worksaround a problem with URL encoding on the Yun
// web-server

// Pound symbol and Degree symbol added to 0x1d and
// 0x1e respectively to prevent the need for an extended
// ASCI character set - requiress client software to
// perform character remapping

const unsigned char Font8x5[][FONT_PITCH] PROGMEM = {
// special remapped characters
{0x00,0x56,0x79,0x51,0x252,0x40},  // £ 0x1d 29 (pound)
{0x00,0x06,0x09,0x09,0x06,0x00},   //   0x1e 30 (degree symbol)
{0x00,0x20,0x10,0x08,0x04,0x02},   // / 0x1f 31 (additional forward slash)
// ASCII
{0x00,0x00,0x00,0x00,0x00,0x00},   //   0x20 32 (space)
...
{0x00,0x3c,0x3c,0x3c,0x3c,0x00}    // unknown character (0x7F)
};
